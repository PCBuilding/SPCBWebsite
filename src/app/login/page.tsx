...
export default function Login() {
  ...
  return (
    <div className="mx-auto flex max-w-2xl flex-col items-center pt-28">
      ...
      <form
        action=""
        className="mt-8 flex w-full flex-col gap-5 px-10"
      ...
      >
        <div>
          ...
          <input
            ...
            type="email"
            name="email"
            className="mt-2 block w-full rounded-md border border-gray-200 bg-gray-100 px-4 py-2 outline-none"
            placeholder="Email"
        ...
        <input
          type="submit"
          value="Login"
          className="cursor-pointer rounded-md bg-blue-500 py-2 text-sm text-white"
        />
      </form>
